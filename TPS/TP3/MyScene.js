...
class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.509*0.3,0.321*0.3,0.003*0.3,1.0);
        this.material4.setDiffuse(0.509,0.321,0.003,1.0);
        this.material4.setSpecular(0.509*0.2,0.321*0.2,0.003*0.2,0.1);
